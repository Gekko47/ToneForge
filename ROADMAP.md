...
| Content Consistency Review C1–C10                                                | H — Superseded by Phase 5 | NOT STARTED                     | C1–C10 are **cross-report, non-deterministic** checkers in a separate engine with its own pipeline and its own opt-in toggle — not a build-stage sequence and not part of the deterministic engine. The reserved seam still contains no engine. | Scoped as Phase 5, which is the single sanctioned exception to deterministic-first. The old "reserved until release" constraint is superseded: the engine never runs in the typing loop or observer, and reuses the already-configured provider and model. |
...
| 5          | Cross-report non-deterministic C1–C10 consistency engine and task-pane integration                                                         | NOT STARTED | Contracts are settled and Phase 5 begins next. The engine is the single sanctioned exception to deterministic-first: it runs separately, never in the typing loop or observer, and reuses the already-configured provider and model under its own opt-in toggle.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
