...
| Test suite                          | Full Vitest suite passes with 73 files and 693 tests; focused Phase 0/1 regression suites pass.                                                                                                                                                                                                                                                                                                                                                                                       | Warning/refusal tests intentionally emit diagnostic stderr logs.                                                                                                      |
| Coverage                            | `npm run test:coverage` passes the 80% gate with 92.90% lines, 92.90% statements, 83.75% functions, and 81.53% branches; taskpane behavior is component-tested and built separately.                                                                                                                                                                                                                                                                                                  | `all: false` avoids Windows V8 path-case duplicate records; untested entrypoint TSX is not counted as exercised core code.                                            |
